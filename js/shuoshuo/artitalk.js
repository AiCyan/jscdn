...
$("head").append(
  '<script src="https://cdn.jsdelivr.net/gh/drew233/Artitalk/source/os.min.js"></script>'
);
...
function savecontent() {
  ...
  if (shuoshuo == "") {
    document.getElementById("preview").innerHTML =
      "<center><pre><code>内容不能为空</code></pre></center>";
    return;
  }
