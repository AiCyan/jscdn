    ...
    case 1:
      if (ele.src.includes("https://cn.gravatar.com/avatar")) {
        ele.src = ele.src.replace(
          ...
          "https://cdn.jsdelivr.net/gh/AiCyan/jscdn@1.6/img/other/gravatar.jpg"
        );
      } else {
        ele.src =
          "https://cdn.jsdelivr.net/gh/AiCyan/jscdn@1.6/img/other/default_avatar.jpg";
      }
      break;
    case 2:
      ele.src =
        "https://cdn.jsdelivr.net/gh/AiCyan/jscdn@1.6/img/other/default_gavatar.png";
      break;
    case 3:
      ele.src =
        "https://cdn.jsdelivr.net/gh/AiCyan/jscdn@1.6/img/other/image-404.png";
      break;
    default:
      ele.src =
        "https://cdn.jsdelivr.net/gh/AiCyan/jscdn@1.6/img/other/image-404.png";
...
$(function () {
  ...
  console.log(
    ...
    "background:#24272A; color:#ffffff;",
    "",
    "https://github.com/AiCyan/Sakura"
  );
  console.log(
    "%c CDN %c",
    "background:#24272A; color:#ffffff;",
    "",
    "https://github.com/AiCyan/jscdn"
  );
});
