    ...
    var sure = function () {
        ...
        botui.message
          ...
          .then(function () {
            botui.message
              .add({
                delay: 1500,
                content: "但是向往技术,渴望成为一名大神😁",
              })
              .then(function () {
                botui.message
                  .add({
                    delay: 1200,
                    content: "我会努力的,大家也要一起努力!😎",
                  })
                  .then(function () {
                    botui.message
                      .add({
                        delay: 1500,
                        content: "主要方向前端,偶尔喜欢捣鼓一些稀奇古怪的东西🤣",
                      })
                      .then(function () {
                        botui.message
                          .add({
                            delay: 1500,
                            content: "你喜欢些什么呢,留言给我吧🤭",
                          })
                          .then(function () {
                            botui.message
                              .add({
                                delay: 1800,
                                content: "我喜欢看书,希望有一天能写出一些东西😌",
                              })
                              .then(function () {
                                botui.action
                                  .button({
      ...
      thirdpart = function () {
        botui.message
          .add({
            delay: 1e3,
            content:
              "aicyan是愛ちゃん的罗马音，没什么太大的含义,主要是以前看过一本小说里面女主名字叫爱,就是比较喜欢这个名字,嘻嘻😝~",
          })
          .then(function () {
            botui.action
              .button({
      ...
      fourthpart = function () {
        botui.message
          .add({
            delay: 1e3,
            content: "emmmm...=.=,没啥太大的含有,主要是我觉得好记😂",
          })
          .then(function () {
            botui.message
              .add({
